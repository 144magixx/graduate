...
from implementations.spectrum_tsac_20260921.paper_baselines import suite
...
class PaperSuiteTests(unittest.TestCase):
    def test_import_before_gate_does_not_load_torch_or_numpy(self):
        command = "import sys; import implementations.spectrum_tsac_20260921.paper_baselines.suite; assert 'torch' not in sys.modules; assert 'numpy' not in sys.modules"
