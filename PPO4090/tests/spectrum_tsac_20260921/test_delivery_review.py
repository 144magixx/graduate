...
from implementations.spectrum_tsac_20260921.train import run_training
from implementations.spectrum_tsac_20260921.evaluate import evaluate_run
from tests.spectrum_tsac_20260921.test_integration import tiny_config
...
def test_evaluation_scenario_identity_cannot_escape_output(tmp_path):
    ...
    with patch("implementations.spectrum_tsac_20260921.artifacts.SPECTRUM_OUTPUT_DIR", tmp_path / "runs"):
