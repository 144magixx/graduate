...
from implementations.spectrum_tsac_20260921.research_stats import summarize_runs, compare_runs
...
class ResearchStatsTests(unittest.TestCase):
    ...
    def test_two_by_two_configs_only_change_actor_and_critic(self):
        folder = Path(__file__).resolve().parents[2]/"implementations"/"spectrum_tsac_20260921"/"configs"
