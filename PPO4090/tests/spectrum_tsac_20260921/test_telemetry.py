...
from implementations.spectrum_tsac_20260921.config import TelemetryConfig
from implementations.spectrum_tsac_20260921.dashboard.api import create_app
from implementations.spectrum_tsac_20260921.telemetry import Recorder, RecorderError
from implementations.spectrum_tsac_20260921.telemetry.legacy import inspect_legacy
from implementations.spectrum_tsac_20260921.telemetry.recorder import export_run
from implementations.spectrum_tsac_20260921.telemetry.storage import DB_NAME, readonly, reconstruct
...
def test_sparse_delta_does_not_repeat_static_geometry(tmp_path):
    from implementations.spectrum_tsac_20260921.telemetry.storage import state_delta, apply_delta
    before = snapshot()
