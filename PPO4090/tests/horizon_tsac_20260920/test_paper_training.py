...
import pytest
import torch
from implementations.horizon_tsac_20260920 import artifacts
...
from implementations.horizon_tsac_20260920.paper_baselines.train import train_baseline
from implementations.horizon_tsac_20260920.paper_baselines.specs import adapt_config
...
def test_complete_local_baseline_chain(algorithm,tmp_path):
    ...
    with patch.object(artifacts,'HORIZON_OUTPUT_DIR',tmp_path/'runs'):
