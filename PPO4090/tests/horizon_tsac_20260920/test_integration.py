...
from implementations.horizon_tsac_20260920.artifacts import atomic_json,load_checkpoint
...
from implementations.horizon_tsac_20260920.train import run_training,prepare_dataset
...
class IntegrationTests(unittest.TestCase):
    def test_training_checkpoint_exact_boundary_resume_and_export(self):
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            with patch("implementations.horizon_tsac_20260920.artifacts.HORIZON_OUTPUT_DIR",root/"runs"):
