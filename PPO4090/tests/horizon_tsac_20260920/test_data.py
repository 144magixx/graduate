...
from implementations.horizon_tsac_20260920.data.loader import load_scenario, scenario_from_rows
from implementations.horizon_tsac_20260920.data.schema import CoverageScenario
from implementations.horizon_tsac_20260920.data.augment import augment_scenario
...
class DataTests(unittest.TestCase):
    ...
    def test_legacy_reference_frozen_sequence_and_rng(self):
        from implementations.horizon_tsac_20260920.legacy_reference import replay_legacy
