...
from implementations.horizon_tsac_20260920.config import Config, load_config
...
class ScheduleTests(unittest.TestCase):
    def run_case(self, config):
        with tempfile.TemporaryDirectory() as temp:
            ...
            with patch.object(artifacts, "HORIZON_OUTPUT_DIR", root/"运行"), patch.object(train, "perform_updates", side_effect=track_updates), \
