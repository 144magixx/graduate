...
from implementations.legacy_ppo.state_1603 import rl_utils_1603 as rl_utils
from implementations.legacy_ppo.state_1603.Environment_1603 import SatelliteFreqState, BeamInfo, Env, CurrentBeamState, beam_num
...
class PPO:
    ...
    def init_logging(self):
        # 使用正斜杠定义路径，并确保目录存在
        log_dir = get_output_dir("legacy_state_1603", "logs")
...
model_dir = get_output_dir("legacy_state_1603", "models")
