...
import os
from implementations.legacy_ppo.state_1603.Environment_1603 import BeamInfo
...
def train_on_policy_agent(env, agent, num_episodes):
    ...
    for episode in range(num_episodes):  # 将训练分为 10 个阶段
        ...
        print(f"Episode {episode}, Reward: {episode_return:.2f}, Satisfaction: {episode_satisfaction:.2f}, actor_loss{actor_loss}, critic_loss{critic_loss},util{util},occupy{occupy},interfere{env.interfere_num},inrange{env.interfere_in_range_num}")
...
def plot_reward(rewards, window_size=20):
    ...
    save_dir = get_output_dir("legacy_state_1603", "figures")
