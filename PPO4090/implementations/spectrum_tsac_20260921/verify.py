...
import sys
import time
from project_paths import PROJECT_ROOT,SPECTRUM_REPORT_DIR
...
def main():
    ...
    for path in (PROJECT_ROOT/"implementations").rglob("*.py"):
        ...
        if "spectrum_tsac_20260921" in path.parts:
            new.append(name)
    ...
    atomic_json(SPECTRUM_REPORT_DIR/"Spectrum静态检查与导入验收.json",result)
