...
def run_benchmark():
    ...
    return dict(purpose="220正需求容量shape fixture，不是第一阶段产物，不进入研究训练数据", passed=True,
        command="python -m implementations.spectrum_tsac_20260921.rl.benchmark", versions=config.semantic_versions(),
...
def main():
    ...
    if args.output:
        ...
        target = get_output_dir("spectrum_tsac_20260921", "数学验收") / "性能与容量短测.json"
